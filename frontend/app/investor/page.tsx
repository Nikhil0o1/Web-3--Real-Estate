...
export default function InvestorPlaceholder() {
  return (
      ...
      <main className="grid flex-1 place-items-center px-6">
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1 text-[11px] uppercase tracking-wider text-muted-foreground">
            Investor experience — coming next
          </span>
          <h1 className="mt-4 text-3xl font-semibold tracking-tight">
            The investor dashboard is on the way.
          </h1>
          <p className="mt-2 text-sm text-muted-foreground">
            The new investor portfolio, claim flow, and yield analytics are being built next, on top of the same
